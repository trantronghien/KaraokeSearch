...
public class SQLDatabaseSource {
    ...
    public List<SongQuery> danhsachbaihattheotacgia(String chuoi){
        List<SongQuery> list = new ArrayList<SongQuery>();

        if (chuoi.isEmpty()) {
            chuoi = "......";
            String[] Column = {DatabaseHelper.SONG_ID, DatabaseHelper.SONG_TITLE,
                    DatabaseHelper.SONG_TITLE_SIMPLE, DatabaseHelper.SONG_TITLE_MINI,
                    DatabaseHelper.SONG_LYRIC, DatabaseHelper.SONG_SOURCE, DatabaseHelper.SONG_FAVORITE};

            String truyvan = "Select " + Column[0] + "," + Column[1]
                    + " , " + Column[2] + " , " + Column[3] + " , " + Column[4] + " , " + Column[5] + " , " + Column[6] + " From "
                    + DatabaseHelper.TABLE_SONG + " Where " + DatabaseHelper.SONG_SOURCE + " LIKE '" + chuoi.toLowerCase() + "%' "
                    + " OR " + DatabaseHelper.SONG_TITLE_MINI + " LIKE '" + chuoi.toLowerCase() + "%' ";
            // +"OR" + DatabaseHelper.SONG_SOURCE +" LIKE '%" + chuoi.toUpperCase() +"%' ";
            ...
            String truyvan = "Select " + Column[0] + "," + Column[1]
                    + " , " + Column[2] + " , " + Column[3] + " , " + Column[4] + " , " + Column[5] + " , " + Column[6] + " From "
                    + DatabaseHelper.TABLE_SONG + " Where " + DatabaseHelper.SONG_SOURCE + " LIKE '" + chuoi.toUpperCase() + "%' " + " OR "
                    + DatabaseHelper.SONG_TITLE_MINI + " LIKE '" + chuoi.toLowerCase() + "%' ";
//             +"Or" + DatabaseHelper.SONG_TITLE_MINI +" LIKE '%" + chuoi.toUpperCase() +"%' ";
            Cursor c = db.rawQuery(truyvan, null);
            c.moveToFirst();
            while (!c.isAfterLast()) {
                SongQuery item = new SongQuery();
    ...
    public List<SongQuery> danhsachbaihattheoma(String chuoi) {
        List<SongQuery> list = new ArrayList<SongQuery>();
        if (chuoi.isEmpty()) {
            chuoi = "......";
            String[] Column = {DatabaseHelper.SONG_ID, DatabaseHelper.SONG_TITLE,
            ...
            String truyvan = "Select " + Column[0] + "," + Column[1]
                    + " , " + Column[2] + " , " + Column[3] + " , " + Column[4] + " , " + Column[5] + " , " + Column[6] + " From "
                    + DatabaseHelper.TABLE_SONG + " Where " + DatabaseHelper.SONG_TITLE_SIMPLE + " LIKE '" + chuoi.toLowerCase() + "%' "
                    + " OR " + DatabaseHelper.SONG_TITLE_MINI + " LIKE '" + chuoi.toLowerCase() + "%' ";
            // +"OR" + DatabaseHelper.SONG_SOURCE +" LIKE '%" + chuoi.toUpperCase() +"%' ";
            Cursor c = db.rawQuery(truyvan, null);
            c.moveToFirst();
            ...
            String truyvan = "Select " + Column[0] + "," + Column[1]
                    + " , " + Column[2] + " , " + Column[3] + " , " + Column[4] + " , " + Column[5] + " , " + Column[6] + " From "
                    + DatabaseHelper.TABLE_SONG + " Where " + DatabaseHelper.SONG_TITLE_SIMPLE + " LIKE '" + chuoi.toLowerCase() + "%' " + " OR "
                    + DatabaseHelper.SONG_TITLE_MINI + " LIKE '" + chuoi.toLowerCase() + "%' ";
//             +"Or" + DatabaseHelper.SONG_TITLE_MINI +" LIKE '%" + chuoi.toUpperCase() +"%' ";
            Cursor c = db.rawQuery(truyvan, null);
            c.moveToFirst();
