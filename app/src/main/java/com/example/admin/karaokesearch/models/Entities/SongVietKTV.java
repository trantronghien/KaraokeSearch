 ...
 */
@Entity
public class SongVietKTV extends SongTable implements Parcelable {
    @Id()
    private long id;
    private int ENT;
    private int OPT;
    ...
    @Keep
    public SongVietKTV(long id, int ENT, int OPT, int ZROWID, int ZSVOL, String ZSABBR, String ZSLANGUAGE, String ZSLYRIC, String ZSLYRICCLEAN, String ZSMANUFACTURE, String ZSMETA, String ZSMETACLEAN, String ZSNAME, String ZSNAMECLEAN, String ZYOUTUBE) {
        this.id = id;
        this.ENT = ENT;
        this.OPT = OPT;
        this.ZROWID = ZROWID;
    ...
    protected SongVietKTV(Parcel in) {
        id = in.readLong();
        ENT = in.readInt();
        OPT = in.readInt();
        ZROWID = in.readInt();
    ...
    public static final Creator<SongVietKTV> CREATOR = new Creator<SongVietKTV>() {
        @Override
        public SongVietKTV createFromParcel(Parcel in) {
            return new SongVietKTV(in);
        }

        @Override
        public SongVietKTV[] newArray(int size) {
            return new SongVietKTV[size];
        }
    };
