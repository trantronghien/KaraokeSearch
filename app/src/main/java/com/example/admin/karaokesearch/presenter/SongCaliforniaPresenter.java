...
public class SongCaliforniaPresenter extends BaseSongPresenter {
    public SongCaliforniaPresenter(BaseAbstractView view, BaseHelperManager manager) {
        super(view , manager);
    }
    ...
    public void queryData(final CharSequence charSequence) {
        ...
        new TaskSearch<SongCalifornia>(search) {
            @Override
            ...
            @Override
            protected List<SongCalifornia> doInBackground(String... params) {
                List<SongCalifornia> listResuft;
            ...
            @Override
            protected void onPostExecute(List<SongCalifornia> list) {
