 ...
 */
@Entity()
public class SongArirang extends SongTable implements Parcelable {
    ...
    @Keep
    public SongArirang(long id, int ENT, int OPT, int ZROWID, int ZSVOL, String ZSABBR, String ZSLANGUAGE, String ZSLYRIC, String ZSLYRICCLEAN, String ZSMANUFACTURE, String ZSMETA, String ZSMETACLEAN, String ZSNAME, String ZSNAMECLEAN, String ZYOUTUBE) {
        this.id = id;
        this.ENT = ENT;
        this.OPT = OPT;
        this.ZROWID = ZROWID;
    ...
    protected SongArirang(Parcel in) {
        id = in.readLong();
        ENT = in.readInt();
        OPT = in.readInt();
        ZROWID = in.readInt();
    ...
    public static final Creator<SongArirang> CREATOR = new Creator<SongArirang>() {
        @Override
        public SongArirang createFromParcel(Parcel in) {
            return new SongArirang(in);
        }

        @Override
        public SongArirang[] newArray(int size) {
            return new SongArirang[size];
        }
    };
