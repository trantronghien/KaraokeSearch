 ...
 */
@Entity
public class SongMusiccore extends SongTable implements Parcelable {
    @Id()
    private long id;
    private int ENT;
    private int OPT;
    ...
    @Keep
    public SongMusiccore() {
    }

    @Keep
    public SongMusiccore(long id, int ENT, int OPT, int ZROWID, int ZSVOL, String ZSABBR, String ZSLANGUAGE, String ZSLYRIC, String ZSLYRICCLEAN, String ZSMANUFACTURE, String ZSMETA, String ZSMETACLEAN, String ZSNAME, String ZSNAMECLEAN, String ZYOUTUBE) {
        this.id = id;
        this.ENT = ENT;
        this.OPT = OPT;
        this.ZROWID = ZROWID;
    ...
    protected SongMusiccore(Parcel in) {
        id = in.readLong();
        ENT = in.readInt();
        OPT = in.readInt();
        ZROWID = in.readInt();
    ...
    public static final Creator<SongMusiccore> CREATOR = new Creator<SongMusiccore>() {
        @Override
        public SongMusiccore createFromParcel(Parcel in) {
            return new SongMusiccore(in);
        }

        @Override
        public SongMusiccore[] newArray(int size) {
            return new SongMusiccore[size];
        }
    };
